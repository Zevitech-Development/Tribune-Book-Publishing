...
import WhyHireUsSectionImg from "../../../public/images/why-hire-us-section-img.png";

const WhyHireUsSection = () => {
  return (
    <section className="layout-standard section-padding-standard flex items-center justify-between gap-12">
      <div className="flex flex-col justify-center gap-4">
        <h1 className="lg:text-4xl md:text-3xl text-2xl !leading-[120%] text-heading font-libre font-bold max-w-[600px]">
