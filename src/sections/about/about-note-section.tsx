...
function AboutNoteSection() {
  return (
    <section className="layout-standard section-margin-standard flex flex-col items-center gap-6 text-center relative section-padding-standard">
      <div className="absolute -top-6 -left-6 md:-top-2 md:-left-8 w-10 md:w-24 opacity-30">
        <Image
      ...
      <div className="absolute -bottom-6 -right-6 md:-bottom-8 md:-right-8 w-10 md:w-24 opacity-30">
        <Image
