...
import PPCForm from "@/forms/ppc-form";
...
function PublishBookHeroSection() {
  ...
  return (
    <section className="relative w-full bg-publish-book-hero bg-cover bg-no-repeat bg-center section-padding-standard">
        ...
        <div className="flex flex-col justify-center gap-8 lg:col-span-3 col-span-1">
          <div className="flex flex-col gap-2">
            <h1 className="text-2xl font-bold text-primary font-libre">
              Transform Your Story into a Published Success
            </h1>
            <h1 className="lg:text-4xl md:text-3xl text-2xl !leading-[135%] text-white font-libre font-bold">
              Publish Your Book with Ease, Confidence & Full Support
            </h1>
          </div>
...
export default PublishBookHeroSection;
